                ...
                <div className='sm:w-[450px] h-[200px]  p-4 flex gap-3 flex-col justify-between' >
                    <header className='flex flex-col justify-between'>
                        <div className='flex justify-between'>
                            ...
                            <span>
                                <button className='hover:bg-slate-200 rounded p-1 -mt-0.5'>
                    ...
                    <main className='grow flex flex-col justify-between'>
                        ...
                        <div className='self-end flex gap-4'>
                            ...
                            <button className='text-white text-sm font-semibold  px-4 py-2 rounded bg-red-500 hover:bg-red-700' onClick={()=> deleteTask()}>
                                Delete
                            </button>
                        </div>
                    </main>
