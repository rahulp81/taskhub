...
function ViewContainer() {
    return (
        <button className='hover:bg-blue-50 rounded-md flex justify-center self-center gap-2 items-end group mt-1 p-1'>
            <span>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={24} height={24} className='fill-gray-600 group-hover:fill-black'>
